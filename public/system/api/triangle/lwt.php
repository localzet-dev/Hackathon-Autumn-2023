...
class LWT
{
    ...
    static ?string $LWT_PRIVATE_KEY = <<<LWT
    -----BEGIN EC PRIVATE KEY-----
    -----END EC PRIVATE KEY-----
    LWT; // Закрытый ключ в формате PEM (ECDSA)
    static ?string $LWT_PUBLIC_KEY = <<<LWT
    -----BEGIN PUBLIC KEY-----
    -----END PUBLIC KEY-----
    LWT; // Публичный ключ в формате PEM (ECDSA)
    ...
    static ?string $DATA_PRIVATE_KEY = <<<LWT
    -----BEGIN RSA PRIVATE KEY-----
    -----END RSA PRIVATE KEY-----
    LWT; // Закрытый ключ в формате PEM (RSA)
    static ?string $DATA_PUBLIC_KEY = <<<LWT
    -----BEGIN RSA PUBLIC KEY-----
    -----END RSA PUBLIC KEY-----
    LWT; // Публичный ключ в формате PEM (RSA)
